...
def main():
    args_parser = argparse.ArgumentParser(description='Tuning with disco pointer parser')
    ...
    #SEED
    args_parser.add_argument('--seed', type=int, help='seed.', default=1) 
    
    args = args_parser.parse_args()

    logger = get_logger("DiscoPointer")
    print('TRAINING DISCOPOINTER PARSER')	
    ...
    window = 3
    network = NewStackPtrNet(word_dim, num_words, char_dim, num_chars, pos_dim, num_pos, num_filters, window,
